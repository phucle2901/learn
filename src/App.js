...
function App() {
  ...
  const menusMath = ["","Bai1","Bai2","Bai3","Bai4","Bai5","Bai6","Bai7","Bai8","Bai9","Bai10","Bai11","Bai12","Bai13"];
  const nameMath = ["","Tam giác","Tứ giác","Dịnh lý talet","Tam giác đồng dạng","Hình chóp","Giá trị lớn nhất - nhỏ nhất","Hàm số bậc nhất","Chia đa thức với đa thức","Chuyên đề: Tính chất đường phân giác của tam giác","Chuyên đề: Định lý Talet trong tam giác","Chuyên đề: Hằng đẳng thức mở rộng","Chuyên đề: Tam giác đồng dạng","Chuyên đề: Biến đổi biểu thức hữu tỉ"];
